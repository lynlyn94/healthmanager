...
-- 治疗项目（任务创建时可选项）
('TREATMENT_ITEM', 'TUINA', '推拿治疗', 1),
('TREATMENT_ITEM', 'ACUPUNCTURE', '针灸治疗', 2),
('TREATMENT_ITEM', 'ELECTRO', '电针治疗', 3),
('TREATMENT_ITEM', 'CUPPING', '拔罐治疗', 4),
('TREATMENT_ITEM', 'MOXIBUSTION', '艾灸治疗', 5),
('TREATMENT_ITEM', 'EXERCISE', '运动训练', 6),
('TREATMENT_ITEM', 'BALANCE', '平衡训练', 7),
('TREATMENT_ITEM', 'GAIT', '步态训练', 8),
('TREATMENT_ITEM', 'STRENGTH', '肌力训练', 9),
('TREATMENT_ITEM', 'ROM', '关节活动度训练', 10),
('TREATMENT_ITEM', 'SPEECH', '言语训练', 11),
('TREATMENT_ITEM', 'SWALLOW', '吞咽训练', 12),
('TREATMENT_ITEM', 'OCCUPATION', '作业治疗', 13),
('TREATMENT_ITEM', 'ADL', '日常生活能力训练', 14),
('TREATMENT_ITEM', 'HEAT', '热敷治疗', 15),
('TREATMENT_ITEM', 'CRYO', '冷疗', 16),
('TREATMENT_ITEM', 'ULTRASOUND', '超声波治疗', 17),
('TREATMENT_ITEM', 'TENS', '经皮神经电刺激', 18),
('TREATMENT_ITEM', 'TRACTION', '牵引治疗', 19),
('TREATMENT_ITEM', 'MANUAL', '手法松动', 20);
